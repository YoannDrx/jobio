      ...
      <div className="grid w-full gap-4 lg:grid-cols-3">
        ...
        >
          <p className="text-muted-foreground leading-relaxed">
            ...
            traitons uniquement pour fournir le service, sécuriser la plateforme
            et améliorer la qualité produit.
          </p>
          <div className="mt-3 flex flex-wrap gap-2">
            <Badge variant="secondary">Responsable du traitement: Jobio</Badge>
            <Badge variant="secondary">Base légale: exécution du contrat</Badge>
      ...
      >
        <div className="grid gap-3 sm:grid-cols-2">
          ...
          <div className="rounded-xl border p-4">
            ...
            <p className="text-muted-foreground mt-1 text-sm">
              Parsing de missions et génération d&apos;emails à la demande. Les
              données ne sont pas revendues.
            </p>
          </div>
          <div className="rounded-xl border p-4">
      ...
      >
        <div className="grid gap-3 sm:grid-cols-2">
          ...
          <div className="rounded-xl border p-4">
            ...
            <p className="text-muted-foreground mt-1 text-sm">
              Demander l&apos;arrêt ou la réduction d&apos;un traitement donné.
            </p>
          </div>
        </div>
      </PublicSection>
