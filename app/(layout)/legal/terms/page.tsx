    ...
    <>
      ...
      >
          ...
          >
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              <Badge variant="secondary">
                Éditeur: {SiteConfig.company.name}
              </Badge>
        ...
        <PublicSection
          ...
          description="Le modèle économique repose sur les plans Free et Pro."
        >
          <div className="grid gap-3 sm:grid-cols-2">
            <div className="rounded-xl border p-4">
        ...
        >
          <p className="text-muted-foreground text-sm leading-relaxed">
            Jobio s&apos;efforce d&apos;assurer un service fiable, mais ne
            garantit pas une disponibilité ininterrompue. Le service est fourni
            &quot;en l&apos;état&quot;. Jobio ne peut être tenu responsable des
            pertes indirectes, ni des conséquences liées à une mauvaise
        ...
        >
          <p className="text-muted-foreground text-sm leading-relaxed">
            ...
            les parties rechercheront d&apos;abord une résolution amiable. À
            défaut, compétence est attribuée aux juridictions françaises
            compétentes.
          </p>
        </PublicSection>
      </PublicPageShell>
